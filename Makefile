...
lint-py:  ## lint python with ruff
	python -m ruff check ccflow_http
	python -m ruff format --check ccflow_http
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix ccflow_http
	python -m ruff format ccflow_http
...
test:  ## run python tests
	python -m pytest -v ccflow_http/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v ccflow_http/tests --cov=ccflow_http --cov-report term-missing --cov-report xml
